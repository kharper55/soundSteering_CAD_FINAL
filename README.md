All CAD pdfs and RAW files for KiCAD7 and some nice pin mapping references + block diagrams. Custom symbol and footprint library (not provided) needed to rebuild Gerbers (provided as-is). 
